...
class PrepareProductForExport(models.TransientModel):
    ...
    def export_direct_in_woo(self, product_templates):
        ...
        woo_templates = woo_template_obj = self.env["woo.product.template.ept"]
            ...
            woo_product_template_vals = (
                {
                    ...
                    'woo_description': product_template.description_sale or '',
                    'woo_short_description': product_template.description or ''
                })
                ...
                woo_product_template_vals = (
                    {
                        'product_tmpl_id': int(record['PRODUCT_TEMPLATE_ID']),
                        'woo_instance_id': instance_id.id,
                        'woo_categ_ids': woo_categ_ids,
                        'name': record['template_name'],
                        'woo_description': record.get('sale_description') or '',
                        'woo_short_description': record.get('product_description') or ''
                    })
