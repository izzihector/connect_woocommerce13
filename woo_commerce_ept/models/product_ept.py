...
class WooProductTemplateEpt(models.Model):
    ...
    woo_tmpl_id = fields.Integer("Woo Template Id")
        ...
        variation_data.update(
            {
                ...
                'weight': str(variant.product_id.weight), "manage_stock":variant.woo_is_manage_stock
            })
        return variation_data
    ...
    def get_product_data(self, wcapi, instance, woo_template, publish, update_price,
        ...
        if basic_detail:
            ...
            data = {
                ...
                'type': 'simple',
                'title' if old else 'name': woo_template.name, 'description': description,
...
class ProductProductEpt(models.Model):
    ...
    active = fields.Boolean('Active', default=True)
    exported_in_woo = fields.Boolean("Exported In Woo")
    variant_id = fields.Integer("Variant Id")
